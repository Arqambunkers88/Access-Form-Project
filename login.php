...
<body>
    ...
    <main class="auth-card" role="main" aria-labelledby="login-title">
        ...
        <form action="login_process.php" method="POST">
            ...
            <!-- YAHAN FORGOT PASSWORD LINK ADD KIYA HAI -->
            <div style="text-align: left; margin-top: 10px;">
                <a href="forgot_password.php" style="color: var(--primary-color); font-size: 0.9em; font-weight: bold; text-decoration: none;">Forgot Password?</a>
            </div>
