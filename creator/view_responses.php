...
// FIXED: JOIN User table to get Name and Email! Table names lowercase.
$r_stmt = $pdo->prepare("
...
// Update Array Structure to hold Name and Email
$responses =[];
    ...
    <div class="app-container">
        ...
        <div class="dashboard-body">
            <main class="main-content" role="main">
                <a href="responses.php" class="btn-secondary" style="margin-bottom: 20px; display: inline-block;">← Back to Responses</a>
                        ...
                        <div class="table-responsive" tabindex="0">
                            <table class="data-table">
                                <thead>
                                    <tr>
                                        <th>Response ID</th>
                                        <th>Respondent Name</th> <!-- NEW COLUMN -->
                                        <th>Email Address</th>   <!-- NEW COLUMN -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo htmlspecialchars($data['name']); ?></strong></td> <!-- NAME DATA -->
                                        <td><?php echo htmlspecialchars($data['email']); ?></td>                 <!-- EMAIL DATA -->
                                        <?php foreach($questions as $q): ?>
